...
- [ ] Task 3: Make root deployment configuration canonical and CSP-complete.
  - Acceptance: Static CSP is in root `_headers`; stale `src/site` config is removed; ADR reflects static versus dynamic policy delivery.
...
- [ ] Task 4: Verify headers through the generated Pages preview.
